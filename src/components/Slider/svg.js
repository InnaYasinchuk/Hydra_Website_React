...
export const SwiperLeft = () => (
  ...
  <path d="M10.1666 17.9166L2.24996 9.99996L10.1666 2.08329" stroke="#433D60" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)

export const SwiperRight = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="12" height="20" viewBox="0 0 12 20" fill="none">
  <path d="M1.83337 17.9166L9.75004 9.99996L1.83337 2.08329" stroke="#433D60" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)